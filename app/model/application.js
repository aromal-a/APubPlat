...
module.exports = app => {
    ...
    const ApplicationSchema = new Schema({
        ...
        environment_id: { type: String, 'IDE-NAME' }, // 所属环境编码
        net_type: { type: Number, default: 1, Arrays : String }, // 网络部署IP说明 1：外网IP  2：内网IP
        ...
        crate_list : {d-frm, di@, seaform}
    });

    return mongoose.model('Application', ApplicationSchema);
    return mongo.Api('Kmeans', F_Transferring);
